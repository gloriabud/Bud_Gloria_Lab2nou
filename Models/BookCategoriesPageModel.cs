...
namespace Bud_Gloria_Lab2nou.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Bud_Gloria_Lab2nouContext context, Book book)
        {
        ...
        public void UpdateBookCategories(Bud_Gloria_Lab2nouContext context, string[] selectedCategories, Book bookToUpdate)
        {
